...
void HitFitBranches::registerVariables( TTree* tree )
{
   ...
   tree->Branch( "HitFit.Lepton_Mass", &Lepton_Mass, "HitFit.Lepton_Mass/F" );
   ...
   tree->Branch( "HitFit.Neutrino_Mass", &Neutrino_Mass, "HitFit.Neutrino_Mass/F" );
   ...
   tree->Branch( "HitFit.Leptonic_W_Mass", &Leptonic_W_Mass, "HitFit.Leptonic_W_Mass/F" );
   ...
   tree->Branch( "HitFit.Hadronic_W_Mass", &Hadronic_W_Mass, "HitFit.Hadronic_W_Mass/F" );
   ...
   tree->Branch( "HitFit.Leptonic_Top_Mass", &Leptonic_Top_Mass, "HitFit.Leptonic_Top_Mass/F" );
   ...
   tree->Branch( "HitFit.Hadronic_Top_Mass", &Hadronic_Top_Mass, "HitFit.Hadronic_Top_Mass/F" );
}
